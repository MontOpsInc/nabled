...
| `MAG-D-017` | `qr::solve_least_squares` | `qr::solve_least_squares_view` | `M` only | inherits real `qr::decompose` gates in non-LAPACK path | dense matrix case `qr::solve_least_squares` + counters | Verified |
