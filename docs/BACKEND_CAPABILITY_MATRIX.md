...
The `check` workflow job publishes capability artifacts generated by
`src/bin/backend_capability_report.rs`:

1. `coverage/backend-capabilities/baseline/summary.json`
2. `coverage/backend-capabilities/baseline/summary.md`
3. `coverage/backend-capabilities/lapack-linux/summary.json`
4. `coverage/backend-capabilities/lapack-linux/summary.md`
