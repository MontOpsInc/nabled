...
Next phase:
1. GPU phase-2 hardening baseline is complete:
   - sparse GPU phase-1 (`CSR matvec` + sparse-dense matmat),
   - allocation/copy contract pass for newly accelerated sparse kernels,
