...
/// Ndarray Jacobian/gradient/Hessian routines.
...
mod tests {
    ...
    use super::{JacobianConfig, ndarray_jacobian};
    ...
    fn jacobian_of_quadratic_map() {
        ...
        let x = array![2.0, 3.0];
        let jacobian =
            ndarray_jacobian::numerical_jacobian(&f, &x, &JacobianConfig::default()).unwrap();
    ...
    fn gradient_of_sphere() {
        ...
        let gradient =
            ndarray_jacobian::numerical_gradient(&f, &x, &JacobianConfig::default()).unwrap();
