...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let matrix_a = Array2::from_shape_vec(
        (3, 3),
        vec![-1.0_f64, 0.2_f64, 0.0_f64, 0.0_f64, -2.0_f64, 0.3_f64, 0.0_f64, 0.0_f64, -3.0_f64],
    )?;
    let matrix_b = Array2::from_shape_vec((2, 2), vec![-0.5_f64, 0.0_f64, 0.1_f64, -1.5_f64])?;
    let matrix_c = Array2::from_shape_vec(
        (3, 2),
        vec![1.0_f64, 2.0_f64, -0.5_f64, 0.25_f64, 0.0_f64, 1.5_f64],
    )?;
