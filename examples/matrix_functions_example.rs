...
use rust_linalg::matrix_functions::{nalgebra_matrix_functions, ndarray_matrix_functions, MatrixFunctionError};
...
fn main() -> Result<(), MatrixFunctionError> {
    ...
    println!("Expected: diag(e, e²) = diag({}, {})", std::f64::consts::E, std::f64::consts::E * std::f64::consts::E);
    ...
    match nalgebra_matrix_functions::matrix_exp_eigen(&non_square) {
        Err(MatrixFunctionError::NotSquare) => println!("✓ Correctly caught non-square matrix error"),
    ...
    match nalgebra_matrix_functions::matrix_log_eigen(&negative_eigen) {
        Err(MatrixFunctionError::NegativeEigenvalues) => println!("✓ Correctly caught negative eigenvalues error"),
